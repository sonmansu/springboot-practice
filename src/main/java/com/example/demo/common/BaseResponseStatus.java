...
public enum BaseResponseStatus {
    ...
    POST_MEMOS_EMPTY(false, HttpStatus.NOT_FOUND.value(), "..."),

    /** sm 작성 **/
    // [POST] /memos
    POST_MEMOS_EMPTY_MEMO(false, HttpStatus.BAD_REQUEST.value(), "메모를 입력해주세요."),
    POST_USERS_EXISTS_MEMO(false,HttpStatus.BAD_REQUEST.value(),"중복된 메모입니다."),
